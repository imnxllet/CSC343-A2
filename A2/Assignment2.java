	...
	*/
	...
	public ArrayList<String> findAcquaintances(String artist1, String artist2) {
		...
		try{	
			...
			String q4 = "SET search_path TO artistdb; CREATE VIEW CollabA2 AS SELECT a1.name AS name1, a2.name AS name2 FROM Collaboration c, Artist a1, Artist a2 WHERE a1.artist_id = c.artist1 AND a2.artist_id = c.artist2 AND (a1.name = " + artist2 +  "OR a2.name = " + artist1 + ");" ;
